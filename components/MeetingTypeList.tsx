...
import { getUserId } from "@/utils/getUserId"; // Import the utility
...
const MeetingTypeList = () => {
  ...
  const createMeeting = async () => {
    ...
    try {
      const id = getUserId(); // Use unique ID for the call
  ...
  const meetingLink = `localhost:3000/${callDetails?.id}`;
